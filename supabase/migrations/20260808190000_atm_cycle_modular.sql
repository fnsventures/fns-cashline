-- Modular ATM cycle helpers (DRY inserts + uniform open-inquiry lookup)
-- Run after 20260808183000_admin_atm_load_override.sql
-- Follow with 20260808191000_atm_cycle_bugfixes.sql
...
-- Ensure legacy bank-draw RPCs stay revoked
